...
"use strict";function area(e){return meta.geomReduce(e,function(e,r){return e+calculateArea(r)},0)}function calculateArea(e){var r,t=0;switch(e.type){case"Polygon":return polygonArea(e.coordinates);case"MultiPolygon":for(r=0;r<e.coordinates.length;r++)t+=polygonArea(e.coordinates[r]);return t;case"Point":case"MultiPoint":case"LineString":case"MultiLineString":return 0;case"GeometryCollection":for(r=0;r<e.geometries.length;r++)t+=calculateArea(e.geometries[r]);return t}}function polygonArea(e){var r=0;if(e&&e.length>0){r+=Math.abs(ringArea(e[0]));for(var t=1;t<e.length;t++)r-=Math.abs(ringArea(e[t]))}return r}function ringArea(e){var r,t,a,n,o,i,u,c=0,l=e.length;if(l>2){for(u=0;u<l;u++)u===l-2?(n=l-2,o=l-1,i=0):u===l-1?(n=l-1,o=0,i=1):(n=u,o=u+1,i=u+2),r=e[n],t=e[o],a=e[i],c+=(rad(a[0])-rad(r[0]))*Math.sin(rad(t[1]));c=c*RADIUS*RADIUS/2}return c}function rad(e){return e*Math.PI/180}var meta=require("@turf/meta"),RADIUS=6378137;module.exports=area,module.exports.default=area;

},{"@turf/meta":11}],2:[function(require,module,exports){
...
},{"@turf/invariant":10}],3:[function(require,module,exports){
"use strict";function booleanPointOnLine(e,r,t){t=t||{};var n=t.ignoreEndVertices;if(!helpers.isObject(t))throw new Error("invalid options");if(!e)throw new Error("pt is required");if(!r)throw new Error("line is required");for(var i=invariant.getCoord(e),a=invariant.getCoords(r),o=0;o<a.length-1;o++){var s=!1;if(n&&(0===o&&(s="start"),o===a.length-2&&(s="end"),0===o&&o+1===a.length-1&&(s="both")),isPointOnLineSegment(a[o],a[o+1],i,s))return!0}return!1}function isPointOnLineSegment(e,r,t,n){var i=t[0],a=t[1],o=e[0],s=e[1],h=r[0],u=r[1],b=t[0]-o,l=t[1]-s,d=h-o,v=u-s;return 0==b*v-l*d&&(n?"start"===n?Math.abs(d)>=Math.abs(v)?d>0?o<i&&i<=h:h<=i&&i<o:v>0?s<a&&a<=u:u<=a&&a<s:"end"===n?Math.abs(d)>=Math.abs(v)?d>0?o<=i&&i<h:h<i&&i<=o:v>0?s<=a&&a<u:u<a&&a<=s:"both"===n?Math.abs(d)>=Math.abs(v)?d>0?o<i&&i<h:h<i&&i<o:v>0?s<a&&a<u:u<a&&a<s:void 0:Math.abs(d)>=Math.abs(v)?d>0?o<=i&&i<=h:h<=i&&i<=o:v>0?s<=a&&a<=u:u<=a&&a<=s)}var invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=booleanPointOnLine,module.exports.default=booleanPointOnLine;

},{"@turf/helpers":8,"@turf/invariant":10}],4:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/meta":11}],5:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/invariant":10}],6:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function convex(e,r){if(r=r||{},!helpers.isObject(r))throw new Error("options is invalid");var n=r.concavity||1/0,t=[];if(meta.coordEach(e,function(e){t.push([e[0],e[1]])}),!t.length)return null;var o=concaveman(t,n);return o.length>3?helpers.polygon([o]):null}var concaveman=_interopDefault(require("concaveman")),meta=require("@turf/meta"),helpers=require("@turf/helpers");module.exports=convex,module.exports.default=convex;

},{"@turf/helpers":8,"@turf/meta":11,"concaveman":14}],7:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function difference(e,r){var t=invariant.getGeom(e),n=invariant.getGeom(r),a=e.properties||{};if(t=removeEmptyPolygon(t),n=removeEmptyPolygon(n),!t)return null;if(!n)return helpers.feature(t,a);var u=new turfJsts.GeoJSONReader,i=u.read(t),o=u.read(n),f=turfJsts.OverlayOp.difference(i,o);if(f.isEmpty())return null;var l=new turfJsts.GeoJSONWriter,s=l.write(f);return helpers.feature(s,a)}function removeEmptyPolygon(e){switch(e.type){case"Polygon":return area(e)>1?e:null;case"MultiPolygon":var r=[];if(meta.flattenEach(e,function(e){area(e)>1&&r.push(e.geometry.coordinates)}),r.length)return{type:"MultiPolygon",coordinates:r}}}var turfJsts=require("turf-jsts"),area=_interopDefault(require("@turf/area")),helpers=require("@turf/helpers"),invariant=require("@turf/invariant"),meta=require("@turf/meta");module.exports=difference,module.exports.default=difference;

},{"@turf/area":1,"@turf/helpers":8,"@turf/invariant":10,"@turf/meta":11,"turf-jsts":24}],8:[function(require,module,exports){
...
},{"@turf/clean-coords":5,"@turf/helpers":8,"@turf/invariant":10,"@turf/truncate":12,"turf-jsts":24}],10:[function(require,module,exports){
...
},{"@turf/helpers":8}],12:[function(require,module,exports){
...
},{"@turf/helpers":8,"@turf/meta":11}],13:[function(require,module,exports){
...
},{"turf-jsts":24}],14:[function(require,module,exports){
"use strict";function concaveman(n,e,t){e=Math.max(0,void 0===e?2:e),t=t||0;for(var r,i=fastConvexHull(n),a=rbush(16,["[0]","[1]","[0]","[1]"]).load(n),o=[],s=0;s<i.length;s++){var u=i[s];a.remove(u),r=insertNode(u,r),o.push(r)}var m=rbush(16);for(s=0;s<o.length;s++)m.insert(updateBBox(o[s]));for(var x=e*e,v=t*t;o.length;){var p=o.shift(),l=p.p,h=p.next.p,f=getSqDist(l,h);if(!(f<v)){var d=f/x;u=findCandidate(a,p.prev.p,l,h,p.next.next.p,d,m),u&&Math.min(getSqDist(u,l),getSqDist(u,h))<=d&&(o.push(p),o.push(insertNode(u,p)),a.remove(u),m.remove(p),m.insert(updateBBox(p)),m.insert(updateBBox(p.next)))}}p=r;var c=[];do{c.push(p.p),p=p.next}while(p!==r);return c.push(p.p),c}function findCandidate(n,e,t,r,i,a,o){for(var s=new Queue(null,compareDist),u=n.data;u;){for(var m=0;m<u.children.length;m++){var x=u.children[m],v=u.leaf?sqSegDist(x,t,r):sqSegBoxDist(t,r,x);v>a||s.push({node:x,dist:v})}for(;s.length&&!s.peek().node.children;){var p=s.pop(),l=p.node,h=sqSegDist(l,e,t),f=sqSegDist(l,r,i);if(p.dist<h&&p.dist<f&&noIntersections(t,l,o)&&noIntersections(r,l,o))return l}u=s.pop(),u&&(u=u.node)}return null}function compareDist(n,e){return n.dist-e.dist}function sqSegBoxDist(n,e,t){if(inside(n,t)||inside(e,t))return 0;var r=sqSegSegDist(n[0],n[1],e[0],e[1],t.minX,t.minY,t.maxX,t.minY);if(0===r)return 0;var i=sqSegSegDist(n[0],n[1],e[0],e[1],t.minX,t.minY,t.minX,t.maxY);if(0===i)return 0;var a=sqSegSegDist(n[0],n[1],e[0],e[1],t.maxX,t.minY,t.maxX,t.maxY);if(0===a)return 0;var o=sqSegSegDist(n[0],n[1],e[0],e[1],t.minX,t.maxY,t.maxX,t.maxY);return 0===o?0:Math.min(r,i,a,o)}function inside(n,e){return n[0]>=e.minX&&n[0]<=e.maxX&&n[1]>=e.minY&&n[1]<=e.maxY}function noIntersections(n,e,t){for(var r=Math.min(n[0],e[0]),i=Math.min(n[1],e[1]),a=Math.max(n[0],e[0]),o=Math.max(n[1],e[1]),s=t.search({minX:r,minY:i,maxX:a,maxY:o}),u=0;u<s.length;u++)if(intersects(s[u].p,s[u].next.p,n,e))return!1;return!0}function intersects(n,e,t,r){return n!==r&&e!==t&&orient(n,e,t)>0!=orient(n,e,r)>0&&orient(t,r,n)>0!=orient(t,r,e)>0}function updateBBox(n){var e=n.p,t=n.next.p;return n.minX=Math.min(e[0],t[0]),n.minY=Math.min(e[1],t[1]),n.maxX=Math.max(e[0],t[0]),n.maxY=Math.max(e[1],t[1]),n}function fastConvexHull(n){for(var e=n[0],t=n[0],r=n[0],i=n[0],a=0;a<n.length;a++){var o=n[a];o[0]<e[0]&&(e=o),o[0]>r[0]&&(r=o),o[1]<t[1]&&(t=o),o[1]>i[1]&&(i=o)}var s=[e,t,r,i],u=s.slice();for(a=0;a<n.length;a++)pointInPolygon(n[a],s)||u.push(n[a]);var m=convexHull(u),x=[];for(a=0;a<m.length;a++)x.push(u[m[a]]);return x}function insertNode(n,e){var t={p:n,prev:null,next:null,minX:0,minY:0,maxX:0,maxY:0};return e?(t.next=e.next,t.prev=e,e.next.prev=t,e.next=t):(t.prev=t,t.next=t),t}function getSqDist(n,e){var t=n[0]-e[0],r=n[1]-e[1];return t*t+r*r}function sqSegDist(n,e,t){var r=e[0],i=e[1],a=t[0]-r,o=t[1]-i;if(0!==a||0!==o){var s=((n[0]-r)*a+(n[1]-i)*o)/(a*a+o*o);s>1?(r=t[0],i=t[1]):s>0&&(r+=a*s,i+=o*s)}return a=n[0]-r,o=n[1]-i,a*a+o*o}function sqSegSegDist(n,e,t,r,i,a,o,s){var u,m,x,v,p=t-n,l=r-e,h=o-i,f=s-a,d=n-i,c=e-a,g=p*p+l*l,q=p*h+l*f,S=h*h+f*f,D=p*d+l*c,X=h*d+f*c,Y=g*S-q*q,M=Y,B=Y;0===Y?(m=0,M=1,v=X,B=S):(m=q*X-S*D,v=g*X-q*D,m<0?(m=0,v=X,B=S):m>M&&(m=M,v=X+q,B=S)),v<0?(v=0,-D<0?m=0:-D>g?m=M:(m=-D,M=g)):v>B&&(v=B,-D+q<0?m=0:-D+q>g?m=M:(m=-D+q,M=g)),u=0===m?0:m/M,x=0===v?0:v/B;var b=(1-u)*n+u*t,I=(1-u)*e+u*r,y=(1-x)*i+x*o,C=(1-x)*a+x*s,H=y-b,N=C-I;return H*H+N*N}var rbush=require("rbush"),convexHull=require("monotone-convex-hull-2d"),Queue=require("tinyqueue"),pointInPolygon=require("point-in-polygon"),orient=require("robust-orientation")[3];module.exports=concaveman,module.exports.default=concaveman;

},{"monotone-convex-hull-2d":15,"point-in-polygon":16,"rbush":18,"robust-orientation":19,"tinyqueue":23}],15:[function(require,module,exports){
...
},{"robust-orientation":19}],16:[function(require,module,exports){
...
},{"quickselect":17}],19:[function(require,module,exports){
...
},{"robust-scale":20,"robust-subtract":21,"robust-sum":22,"two-product":25}],20:[function(require,module,exports){
...
},{"two-product":25,"two-sum":26}],21:[function(require,module,exports){
...
module.exports={centroid:require("@turf/centroid"),convex:require("@turf/convex"),difference:require("@turf/difference"),helpers:require("@turf/helpers"),intersect:require("@turf/intersect"),invariant:require("@turf/invariant"),union:require("@turf/union"),booleanPointOnLine:require("@turf/boolean-point-on-line"),booleanPointInPolygon:require("@turf/boolean-point-in-polygon")};
},{"@turf/boolean-point-in-polygon":2,"@turf/boolean-point-on-line":3,"@turf/centroid":4,"@turf/convex":6,"@turf/difference":7,"@turf/helpers":8,"@turf/intersect":9,"@turf/invariant":10,"@turf/union":13}]},{},[27])(27)
});
